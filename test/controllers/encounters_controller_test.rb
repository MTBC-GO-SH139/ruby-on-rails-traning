...
class EncountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encounter" do
    assert_difference('Encounter.count') do
      post encounters_url, params: { encounter: { date: @encounter.date, patient_id: @encounter.patient_id, reason: @encounter.reason } }
    end
  ...
  test "should update encounter" do
    patch encounter_url(@encounter), params: { encounter: { date: @encounter.date, patient_id: @encounter.patient_id, reason: @encounter.reason } }
